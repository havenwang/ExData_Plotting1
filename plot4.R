...
# first plot
with(time_frame_power, plot(datetime, global_active_power_kilowatt, type="l", xlab="", ylab="Global Active Power"))

# second plot
with(time_frame_power, plot(datetime, Voltage, type="l"))
...
legend("topright", pch = "-", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), seg.len = 2, lwd = 2, bty = "n")

# fourth plot
with(time_frame_power, plot(datetime, Global_reactive_power, type="l"))
